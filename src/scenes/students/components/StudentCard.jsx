 ...
 *  - showIdText?: boolean (defaults to false)
 */
export default function StudentCard({
  ...
  const cardCss = useMemo(
    () => `
      ...
      .id-card { background: #0b358a; padding: 3mm; box-sizing: border-box; }
      .id-card__inner {
      ...
      .id-card__row {
        flex: 1; display: grid; grid-template-columns: 28mm 1fr 24mm; gap: 4mm;
        padding: 4mm 3mm 2mm;
      }
      .id-card__avatar {
  ...
  const displayName = (student?.fullName || "").trim(); // or .toUpperCase() if you prefer
        ...
        <div className="id-card__inner">
          <div className="id-card__header">
            <div className="id-card__header-row">
              {schoolLogoUrl ? <img className="id-card__logo" src={schoolLogoUrl} alt="logo" /> : null}
